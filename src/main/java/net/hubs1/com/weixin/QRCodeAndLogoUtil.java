 ...
 * @author weqinjia.liu
 * @Date 2016年7月28日
 * @ClassName QRCodeAndLogoUtil
 */
public class QRCodeAndLogoUtil {
     ...
     */
    public static int createQRCode(String content, String imgPath, String logo, int width, int height, int logoWidth, int logoHeight) {
        try {
    ...
    public static void main(String[] args) {
        ...
        createQRCode(content, imgPath, logoPath, 300, 300, 60, 60);
    }
}
