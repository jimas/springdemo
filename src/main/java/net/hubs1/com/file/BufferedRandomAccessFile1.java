...
public class BufferedRandomAccessFile1 extends RandomAccessFile {  
    ...
    public BufferedRandomAccessFile1(File file, String mode, int size) throws IOException {  
        super(file, mode);  
     ...
     */  
    public BufferedRandomAccessFile1(String name, String mode) throws IOException {  
        this(name, mode, 0);  
    }  
  
    public BufferedRandomAccessFile1(String name, String mode, int size) throws FileNotFoundException {  
        super(name, mode);  
        path_ = name;  
        this.init(size);  
    }  
...
//      }  
    ...
    public long length() throws IOException {  
        ...
        return Math.max(this.curr_+1, super.length());  
    }  
