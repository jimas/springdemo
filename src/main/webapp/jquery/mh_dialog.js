...
window.onload=function(){
	var cssText = "html,body{width:100%;height:100%;margin:0;padding:0;}#mh_layer{background-color:#000;position:fixed;left:0;top:0;z-index:999999;display:none;background-color:rgba(0,0,0,0.6);}#mh_dialog{width:200px;height:60px;text-align:center;border-radius:8px;position:fixed;left:50%;top:36%;margin-left:-106px;margin-top:-56px;z-index:10000000;background-color:#767676;background-repeat:no-repeat;line-height:60px;opacity: 0.8;color: #fff;font-size:14px;font-weight:bold;display:none;letter-spacing:1px;}.mh_success{background-image:url('mh_dialog/images/success.png');color:#1fce11;background-size:32px 32px;background-position:center 20px;border:6px #1fce11 solid;}.mh_loading{background-image:url('mh_dialog/images/loading.gif');color:#333333;background-size:50px 50px;background-position:center 15px;border:6px #333333 solid;}.mh_warning{}.mh_error{background-image:url('mh_dialog/images/error.png');color:#F00;background-size:32px 32px;background-position:center 20px;border:6px #F00 solid;}";
